...
const FACILITY_TYPES = [
    {
        id: "lumber_mill", name: "Lumber Mill", cost: 5000, materialsCost: 25, baseUpkeepRPS: 10,
        description: "Processes logs into usable Building Materials.", output: { resource: "buildingMaterials", amount: 0.2 },
        mainLevelMax: 5,
        upgrades: [
    ...
    {
        id: "basic_workshop", name: "Basic Workshop", cost: 15000, materialsCost: 70, baseUpkeepRPS: 25,
    ...
    {
        id: "small_science_lab", name: "Small Science Lab", cost: 25000, materialsCost: 100, baseUpkeepRPS: 50,
    ...
    },
    {
        ...
        mainLevelMax: 5,
        upgrades: [ { id: "supercomputer_access", name: "Supercomputer", cost: 50000, effect: { outputIncrease: 0.2 }, maxTier: 2} ],
        requiredResearch: "scientific_method_2"
    }
];

const RESEARCH_TOPICS = [
    { id: "basic_education", name: "Basic Education", costRP: 10, requiredLabs: 0, description: "Unlocks Small Science Labs.", prerequisites: [], unlocksFacilityType: ["small_science_lab"], unlocksResearch: ["urban_planning_1", "basic_construction_techniques", "scientific_method_1"] },
    { id: "urban_planning_1", name: "Urban Planning I", costRP: 20, requiredLabs: 1, description: "Unlock basic new rental types.", prerequisites: ["basic_education"], unlocksPropertyType: ["small_apartment", "trailer_home"], unlocksResearch: ["urban_planning_2", "commercial_development_1"] },
    { id: "basic_construction_techniques", name: "Basic Construction", costRP: 25, requiredLabs: 1, description: "Unlocks Basic Workshops. Reduces property monetary costs.", prerequisites: ["basic_education"], unlocksFacilityType: ["basic_workshop"], globalBuff: { type: "property_cost_reduction", percentage: 0.05, scope: "all" }, unlocksResearch: ["advanced_material_processing"] },
    { id: "scientific_method_1", name: "Scientific Method I", costRP: 30, requiredLabs: 1, description: "Improves research efficiency slightly.", prerequisites: ["basic_education"], globalBuff: { type: "research_speed_boost", percentage: 0.05 }, unlocksResearch: ["scientific_method_2", "commercial_logistics"] },
    { id: "urban_planning_2", name: "Urban Planning II", costRP: 50, requiredLabs: 1, description: "Unlocks Suburban Houses.", prerequisites: ["urban_planning_1"], unlocksPropertyType: ["suburban_house"], unlocksResearch: [] },
    { id: "commercial_development_1", name: "Commercial Dev. I", costRP: 40, requiredLabs: 1, description: "Unlocks basic commercial properties.", prerequisites: ["urban_planning_1"], unlocksPropertyType: ["corner_store"], unlocksResearch: [] },
    { id: "advanced_material_processing", name: "Adv. Material Processing", costRP: 60, requiredLabs: 1, description: "More efficient use of building materials for upgrades.", prerequisites: ["basic_construction_techniques"], globalBuff: { type: "material_usage_efficiency", percentage: 0.10 }, unlocksResearch: [] },
    { id: "commercial_logistics", name: "Commercial Logistics", costRP: 50, requiredLabs: 1, description: "Improves RPS for commercial properties.", prerequisites: ["scientific_method_1"], globalBuff: { type: "property_rps_boost", percentage: 0.05, scope: "commercial" }, unlocksResearch: [] },
    { id: "scientific_method_2", name: "Scientific Method II", costRP: 75, requiredLabs: 2, description: "Unlocks Advanced Science Labs. Further improves research efficiency.", prerequisites: ["scientific_method_1"], unlocksFacilityType: ["advanced_science_lab"], globalBuff: { type: "research_speed_boost", percentage: 0.10 }, unlocksResearch: [] }
];
...
function completeResearch(researchId) {
    ...
    if (ownedScienceLabs < requiredLabsCount) {
        console.log(`[GAME] Cannot research "${topic.name}": Requires ${requiredLabsCount} Lab(s) (You have ${ownedScienceLabs}).`); return false;
    }
    if (gameState.researchPoints >= topic.costRP) {
        ...
        console.log(`[GAME] ${message}`); // For science related messages
        updateGameData();
        return true;
    } else {
        console.log(`[GAME] Not enough RP for "${topic.name}". Need ${topic.costRP.toFixed(1)} (Have ${gameState.researchPoints.toFixed(1)}).`); return false;
    }
}
