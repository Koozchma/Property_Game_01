...
const gameData = {
    ...
    idleGenerators: [
        {
            ...
            owned: 0,
            costMultiplier: 1.15,
            upgradeCostMultiplier: 2, // For potential future upgrades of individual generators
            level: 1,
            isUnlocked: true,
        },
        {
    ...
    productionFacilities: [
        {
            ...
            cost: 200, // Cost in MP
            baseCost: 200,
            generates: "pliableMinions", // ID of the secondary resource
            amountPerSecond: 0.1,
            owned: 0,
            costMultiplier: 1.20,
            isUnlocked: false,
    ...
    research: [
        // Tier 1
        {
            ...
            isResearched: false,
            unlocks: [],
            applyEffect: function() { gameData.clickPower += 1; },
            requirements: [],
            tier: 1,
        },
        {
        ...
        // Tier 2
        {
            ...
            tier: 2,
            isInitiallyLocked: true, // Tier 2 starts locked
        },
        {
        ...
        // Add more research items for Tier 2, 3, etc.
    ],
    ...
    assets: [
        {
            ...
            costs: [ // Array of costs
                ...
                { resource: "darkCapital", amount: 50 } // Example, DC needs to be implemented
            ],
            isPurchased: false,
            isUnlocked: false, // Can be unlocked by research or other conditions
            applyEffect: function() { /* e.g., add a global multiplier */ },
            unlockRequirement: { type: "research", id: "someFutureResearch"} // Placeholder
        }
        // More assets
    ],

    currentResearchTier: 1,
};
...
function calculateMPS() {
    ...
    gameData.idleGenerators.forEach(gen => {
        if (gen.isUnlocked) {
            totalMPS += gen.owned * gen.mpPerSecond;
        }
    });
    return totalMPS;
}
